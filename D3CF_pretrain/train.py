...
def train():
    ...
    for step, ((x_i, x_j), _) in enumerate(data_loader):
        ...
        #loss_instance = criterion_softinstance(z_i, z_j)
        loss_cluster = criterion_barlowtwins(c_i, c_j)
...
if __name__ == "__main__":
    ...
    #criterion_softinstance = contrastive_loss.SoftInstanceLoss(args.batch_size, loss_device).to(loss_device)
    #criterion_cluster = contrastive_loss.ClusterLoss(class_num, args.cluster_temperature, loss_device).to(loss_device)
    criterion_barlowtwins = contrastive_loss.BarlowTwinsLoss(class_num, args.cluster_temperature, loss_device, lambd=0.5).to(loss_device)
    # train
