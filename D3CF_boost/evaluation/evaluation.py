...
def net_evaluation(net,test_loader,dataset_size,test_batch_size = 500):
    ...
    for step, (x, y,_) in enumerate(test_loader):
        ...
        #print("5evalate_confidence==============>>>",confidence)
    ...
    #print("NMI:", my_nmi)
    #print("ARI:", my_ari)
    print('C3=> NMI = {:.4f} ARI = {:.4f} ACC = {:.4f}'.format(my_nmi, my_ari, my_acc))


def net_evaluation_cluster(net,test_loader,dataset_size,test_batch_size = 500):
