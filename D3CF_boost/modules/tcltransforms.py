...
class Augmentation:
    ...
    def __call__(self, x):
        #return self.weak_aug(x), self.strong_aug(x), self.val_aug(x) #attention here is changed!
...
def build_transform(is_train, args):
    if args.dataset == "CIFAR-10":
    ...
    elif args.dataset == "ImageNet-10" or args.dataset == "ImageNet-dogs":
        augmentation = Augmentation(
            img_size=256,
            val_img_size=224,
            s=0.5,
        ...
        #The tcltransformer for CIFAR-10
        augmentation = Augmentation(
            img_size=256,
            val_img_size=224,
            s=0.5,
...
def build_transform_doubletcl(is_train, args):
    if args.dataset == "CIFAR-10":
...
class Augmentation1:
    ...
    def __call__(self, x):
        #return self.weak_aug(x), self.strong_aug(x), self.val_aug(x) #attention here is changed!
        return self.strong_aug(x), self.strong_aug(x)
