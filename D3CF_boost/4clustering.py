...
from evaluation import ccevaluation,evaluation
...
if __name__ == "__main__":
    ...
    model_fp = os.path.join(args.model_path, "C3_SL_checkpoint_2.tar")
    #model_fp = os.path.join(args.model_path, "checkpoint_1000.tar")
    model.load_state_dict(torch.load(model_fp, map_location=device.type)['net'])
    model.to(device)

    #evaluation.net_evaluation_cluster(model, data_loader, args.dataset_size, args.test_batch_size)
